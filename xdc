...
## LEDs
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS25 } [get_ports { rx_done }]; #IO_L15P_T2_DQS_13 Sch=led[0]
...
## Pmod header JA
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports cs_adc]
set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS33} [get_ports mosi_adc]
set_property -dict {PACKAGE_PIN AB20 IOSTANDARD LVCMOS33} [get_ports miso_adc]
set_property -dict {PACKAGE_PIN AB18 IOSTANDARD LVCMOS33} [get_ports sclk]
#set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { ja[4] }]; #IO_L9P_T1_DQS_14 Sch=ja[7]
set_property -dict {PACKAGE_PIN AA21 IOSTANDARD LVCMOS33} [get_ports cs_dac]
set_property -dict {PACKAGE_PIN AA20 IOSTANDARD LVCMOS33} [get_ports sck_dac]
set_property -dict {PACKAGE_PIN AA18 IOSTANDARD LVCMOS33} [get_ports dac_out]
